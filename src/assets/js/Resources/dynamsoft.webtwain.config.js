...
var Dynamsoft1 = Dynamsoft || { WebTwainEnv: {} };

///
Dynamsoft1.WebTwainEnv.AutoLoad = true;

///
Dynamsoft1.WebTwainEnv.Containers = [{ContainerId:'dwtcontrolContainer', Width:270, Height:350}];
...
/// Dynamsoft1.WebTwainEnv.ProductKey = 'key1;key2;key3';
Dynamsoft1.WebTwainEnv.ProductKey = 't0068WQAAAJcjRvqhD6KgF7knnL+6aii8vpAK/KBCKtBFdQUHwfxt0JLxUqSva5nf+LkOkVvePUS1q6Ev5GYPSovEn4+3NZg=';

///
Dynamsoft1.WebTwainEnv.Trial = true;

///
// Dynamsoft1.WebTwainEnv.ResourcesPath = 'Resources';

///
Dynamsoft1.WebTwainEnv.IfAddMD5InUploadHeader = false;

///
Dynamsoft1.WebTwainEnv.IfConfineMaskWithinTheViewer = false;


///
/*Dynamsoft1.WebTwainEnv.CustomizableDisplayInfo = {
    ...
    generalMessages: {
        ...
        updatingDService: 'Dynamsoft1 Service is updating ...',
...
/// All callbacks are defined in the dynamsoft1.webtwain.install.js file, you can customize them.
// Dynamsoft1.WebTwainEnv.RegisterEvent('OnWebTwainReady', function(){
