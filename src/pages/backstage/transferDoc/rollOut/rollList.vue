                ...
                <div>
                    ...
                    <div class="table">
                        <el-table :data="list" stripe style="width: 100%">
                          ...
                          <el-table-column prop="档案转递单号" label="转递申请单号"></el-table-column>
                          <el-table-column prop="转递申请时间" label="申请时间"></el-table-column>
                          <el-table-column prop="接收单位" label="接收单位"></el-table-column>
                          <el-table-column prop="接收人姓名" label="接收人"></el-table-column>
                          <el-table-column prop="档案数量" label="档案数量"></el-table-column>
  ...
  methods: {
    ...
    zhuandirecordlist () {
      this.$api.application.zhuandirecordlist({
        ...
        data.转出.forEach((item, index) => {
          item.转递申请时间 = item.转递申请时间.substring(0, 10)
        })
        this.list = data.转出
      })
    },
    ...
    lookDeatil (item) {
      this.$router.push("/home/backstage/rollOut_detail?state=" + item.名称 + '&orderId=' + item.档案转递单号);
    }
  }
}
</script>
