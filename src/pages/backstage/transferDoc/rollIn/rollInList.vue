                ...
                <div>
                    ...
                    <div class="table">
                        <el-table
                            ...
                            <el-table-column prop="送交人姓名" label="转递人"></el-table-column>
                            <el-table-column prop="送交单位" label="转出单位"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    lookDeatil (item) {
      this.$router.push("/home/backstage/rollIn_detail?state=" + item.名称 + '&orderId=' + item.档案转递单号);
    }
  }
}
</script>
