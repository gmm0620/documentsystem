                ...
                <div>
                  ...
                  <div class="table">
                    <el-table :data="list" stripe style="width: 100%">
                      ...
                      <el-table-column prop="材料转递单号" label="转递单号"></el-table-column>
                      <el-table-column prop="申请时间" label="申请时间"></el-table-column>
                      <el-table-column prop="转递单位" label="申请单位"></el-table-column>
                      <el-table-column prop="转递人姓名" label="申请人"></el-table-column>
                      ...
                      <el-table-column prop="名称" label="申请状态"></el-table-column>
                      <el-table-column prop="接收人姓名" label="接收人"></el-table-column>
                      <el-table-column prop="option" label="操作" width="80">
                        <div slot-scope="scope">
                          <button class="look" @click="lookDetail(scope.row)">查看</button>
                        </div>
                      </el-table-column>
                    </el-table>
                    <el-pagination
...
export default {
  ...
  created () {
    ...
    this.get_xianshangjieshou_gengduo()
  },
  methods: {
    // 获取线上接收列表
    get_xianshangjieshou_gengduo () {
      this.$api.application.get_xianshangjieshou_gengduo({
        jgmcm: this.qxfw,
    ...
    lookDetail (item) {
      console.log(item)
    //   if (type === '转档') {
        this.$router.push('/home/backstage/transfer_detail?state=' + item['申请状态'] + '&clzddh=' + item['材料转递单号'])
    //   } else {
    //     this.$router.push('/home/backstage/accept_detail?state=' + item['申请状态'])
    //   }
    },
  }
}
