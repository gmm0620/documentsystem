            ...
            <div>
              ...
              <div class="table">
                <el-table :data="list" stripe style="width: 100%">
                  ...
                  <el-table-column prop="接收单位" label="接收单位"></el-table-column>
                  <el-table-column prop="接收人姓名" label="接收人"></el-table-column>
                  <el-table-column prop="材料类别" label="材料类别"></el-table-column>
                  <el-table-column prop="材料名称" label="材料名称" width="200"></el-table-column>
...
export default {
  ...
  created () {
    ...
    this.get_xianshangzhuanchu_gengduo()
  },
  methods: {
    // 获取线上接收列表
    get_xianshangzhuanchu_gengduo () {
      this.$api.application.get_xianshangzhuanchu_gengduo({
        jgmcm: this.qxfw,
    ...
    lookDeatil (item) {
      ...
      this.$router.push('/home/backstage/roll_detail?state=' + item['申请状态'] + '&clzddh=' + item['材料转递单号'])
    }
  }
}
</script>
