  ...
  <div class="stage2">
    <div class="right">
      <el-card style="width: 100%;height: 100%;">
        ...
        <div id="myCharts" :style="{width: '100%', height: '500%', }" ref="myCharts"></div></el-card>
        ...
        methods: {
            ...
            getTableList () {
                ...
                this.$api.systemSet.queryTitle(
                    ...
                    console.log('rdataesqqqqqq',res)
                    // if (res.code) {
                    this.DocTitle = res.title
                    this.Docnumber = res.number
